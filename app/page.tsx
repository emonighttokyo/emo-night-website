          ...
          >
            <div className="event-card">
              <div className="event-poster">
                <div className="event-poster-text">To Be Announced</div>
              </div>
  ...
  <div className="container bottom-grid">
    ...
    <div className="bottom-left">
      <div className="social-col">
        <a href="https://www.instagram.com/emonighttokyo/" target="_blank" rel="noopener noreferrer">
          INSTAGRAM
        </a>

        <a href="https://www.facebook.com/p/Emo-Night-Tokyo-61567153775254/" target="_blank" rel="noopener noreferrer">
          FACEBOOK
        </a>

        <a href="https://www.tiktok.com/@emonighttokyo" target="_blank" rel="noopener noreferrer">
          TIKTOK
        </a>
      </div>

      <div className="social-col">
        <a href="https://x.com/EmoNightTokyo" target="_blank" rel="noopener noreferrer">
          X (TWITTER)
        </a>

        <a href="https://www.reddit.com/r/EmoNightTokyo/" target="_blank" rel="noopener noreferrer">
          REDDIT
        </a>

        <a href="https://www.bandsintown.com/a/15525557-emo-night-tokyo?came_from=250&utm_medium=web&utm_source=home&utm_campaign=search_bar&noindex=1" target="_blank" rel="noopener noreferrer">
          BANDSINTOWN
        </a>
      </div>
    </div>
